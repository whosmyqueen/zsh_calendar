...
class CalendarController extends ChangeNotifier {
  ...
  nextPage({required Duration duration, Curve curve = Curves.bounceInOut}) {
  ...
  previousPage({required Duration duration, Curve curve = Curves.bounceInOut}) {
    int index = (_pageController.page! - 1).toInt();
    double width = ScreenUtil().screenWidth * index;
    if (_scrollPhysics.status.minScrollExtent > width) {
      return;
  ...
  goToToday({required Duration duration, Curve curve = Curves.bounceInOut}) {
